...
class NoteLanguageUtils {
    ...
    static getInstance() {
        if (!NoteLanguageUtils.instance) {
            NoteLanguageUtils.instance = new NoteLanguageUtils();
        }
        return NoteLanguageUtils.instance;
    }
}

// Export both the class and singleton instance
export { NoteLanguageUtils };
export const noteLanguageUtils = new NoteLanguageUtils();
