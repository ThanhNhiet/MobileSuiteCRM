...
import { useRelationshipDetail } from "../../services/useApi/relationship/UseRelationshipDetail";
...
export default function RelationshipDetailScreen_New() {
    ...
    const handleUpdate = () => {
        ...
        // }
        if (editPerm) {
            navigation.navigate('RelationshipUpdateScreen_New', {
                moduleName,
                recordData: record,
                haveParent,
                relatedLink,
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.loadingContainer}>
                    ...
                    <Text style={styles.loadingText}>{translations.loadingText || 'Loading...'}</Text>
                </View>
            </SafeAreaView>
        );
    }
                ...
                <ScrollView
                    ...
                    refreshControl={
                        <RefreshControl
                            ...
                            title={translations.refreshPull || 'Pull to refresh...'}
                        />
                    }
                >
                    {/* Error Display */}
